...
def provider_patches(mock_config, mock_qdrant_client, mock_embeddings, mock_store):
    ...
    with patch(
        "deepeval.vector_store.qdrant_provider.QdrantClient",
        return_value=mock_qdrant_client,
    ):
        with patch(
            "deepeval.vector_store.qdrant_provider.OpenAIEmbeddings",
            return_value=mock_embeddings,
        ):
            with patch(
                "deepeval.vector_store.qdrant_provider.QdrantVectorStore",
